...
var prefix = "!";
var footer = ("Boubouv2")
var footer2 = ('https://cdn.discordapp.com/attachments/414476552596619264/548133022029840384/Lgog_Offi_vide.png%27)
var color = ("0x78eeff")
...
client.on("guildMemberAdd", member => {
    member.guild.channels.find("name", "aeroport").send('Bienvenue à toi ${member} !')
});

client.on("guildMemberRemove", member => {
    member.guild.channels.find("name", "aeroport").send('${member} vien de quitter !')
});
